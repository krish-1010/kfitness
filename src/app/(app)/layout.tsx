...
import { GoalsProvider } from "./_lib/GoalsContext";
...
// GoalsProvider's state (the things genuinely shared across sections)
// persists without per-page plumbing. /login lives outside this route
// group entirely and never renders any of this.
